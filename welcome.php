...
<header>
    ...
    <div class="song_side">
        <nav>
            ...
            <div class="user">
                <img src="img/SK CODER.png" alt="User" title="SK CODER">
            </div>
        </nav>
        <div class="content">
      ...
      <div class="next-track" onclick="nextTrack()"><i class="fa fa-step-forward fa-2x"></i></div>
            ...
            <div class="item">
                ...
                <li>
                    <img src="img/Anirudh.avif" alt="Anirudh" title="Anirudh">
                </li>
                <li>
    ...
    <div class="master_play">
        ...
        <div class="icon">
            ...
            <a href="" download id="download_music"></a><i class="bi bi-cloud-arrow-down-fill"></i>
